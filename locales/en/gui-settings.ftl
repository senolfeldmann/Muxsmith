...
settings-locale-hint = English and German ship in this version; more languages can be added later without changing this setting's meaning.
settings-locale-option-en = English
settings-locale-option-de = German
settings-save = Save
