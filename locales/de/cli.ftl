...
### convention (reviewed manually, not machine-checked). Terminology per
### Task 21 (#17): Spur/Datei/Profil/Regel/Vorschlag, mkvtoolnix-de anchors
### where one exists. Sie-less imperative (du-Imperativ) for direct CLI
### instructions.
