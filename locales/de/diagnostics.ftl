...
missing-external = Keine Datei passt auf diesen externen Locator.
ambiguous-external = { $count } Dateien passen auf diesen externen Locator; genau eine ist erforderlich.
