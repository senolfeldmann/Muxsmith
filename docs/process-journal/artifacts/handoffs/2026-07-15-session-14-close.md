<!-- snapshot of HANDOFF.md at session-14 final close, 2026-07-15 -->
# Handoff
...
**Date:** 2026-07-15 (session 14 close, final: Plan 5.8 executed and closed; post-plan owner process review landed in the conventions)
...
- **Post-plan owner rulings (session-14 tail, in this repo's
  conventions):** proc-latitude-clause-boundary resolved and promoted to
  Tier 2 (a brief never carries an unresolved design question; latitude
  clauses banned; NEEDS_CONTEXT decision memo is the mid-task channel);
  the promotion-matrix header comments gained the standing-structure
  escalation row (new tracker/file classes gate like product
  boundaries). Details: journal session-14 close entry; the general
  doctrine amendments live agent-side per SI-1.
