<!-- snapshot of HANDOFF.md, 2026-07-17 session-17 late update: sweep-first directive + surface pass resolved -->
# Handoff
...
0. **The next session opens with agent-side process-archive and sweep work
   BEFORE any new plan** (Şenol's directive 2026-07-17; the work order and
   all specifics are tracked agent-side, per the cross-project privacy
   line - do not look for them in this repo).
...
2. **Next-plan kickoff** (Şenol's choice, after the sweep session): Plan 7's
